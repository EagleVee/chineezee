  ...
  <g transform="scale(1, -1) translate(0, -900)">
    <style type="text/css">
        ...
        #make-me-a-hanzi-animation-2 {
          ...
          animation-delay: 2.0397135416666665s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-3 {
          ...
          animation-delay: 2.796712239583333s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-4 {
          ...
          animation-delay: 3.549641927083333s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-5 {
          animation: keyframes5 1.1956380208333333s both;
          animation-delay: 4.536946614583333s;
          animation-timing-function: linear;
        }
      ...
      <path d="M 525 449 Q 555 456 678 469 Q 688 468 696 479 Q 697 489 676 500 Q 673 501 670 503 C 644 517 644 517 621 512 Q 575 503 526 489 L 473 480 Q 422 474 329 463 Q 301 460 322 443 Q 352 418 380 424 Q 423 433 473 441 L 525 449 Z" fill="lightgray"></path>
      ...
      <clipPath id="make-me-a-hanzi-clip-2">
        <path d="M 525 449 Q 555 456 678 469 Q 688 468 696 479 Q 697 489 676 500 Q 673 501 670 503 C 644 517 644 517 621 512 Q 575 503 526 489 L 473 480 Q 422 474 329 463 Q 301 460 322 443 Q 352 418 380 424 Q 423 433 473 441 L 525 449 Z"></path>
      </clipPath>
