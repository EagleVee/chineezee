module.exports = `<svg version="1.1" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="scale(1, -1) translate(0, -900)">
    <style type="text/css">
      ...
      <path d="M 438 427 Q 354 262 119 87 Q 107 75 116 73 Q 125 69 137 74 Q 269 126 386 267 Q 441 342 475 387 C 513 438 463 475 438 427 Z" fill="lightgray"></path>
    
      <path d="M 521 392 Q 678 158 763 98 Q 778 89 794 89 Q 869 99 932 107 Q 960 110 960 117 Q 961 124 929 138 Q 767 198 721 238 Q 616 325 524 439 L 522 439 C 500 459 504 417 521 392 Z" fill="lightgray"></path>
