  ...
  <g transform="scale(1, -1) translate(0, -900)">
    <style type="text/css">
        ...
        #make-me-a-hanzi-animation-4 {
          ...
          animation-delay: 3.4894205729166665s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-5 {
          animation: keyframes5 1.1044921875s both;
          animation-delay: 4.366861979166666s;
          animation-timing-function: linear;
        }
      
    </style>
    
      <path d="M 220 462 Q 275 535 334 641 Q 361 695 385 722 Q 395 734 389 747 Q 385 760 354 783 Q 324 801 305 800 Q 286 797 295 775 Q 311 741 300 710 Q 236 539 70 324 Q 60 314 58 307 Q 54 295 69 298 Q 105 307 196 429 L 220 462 Z" fill="lightgray"></path>
    
      <path d="M 196 429 Q 217 398 219 310 Q 219 193 196 95 Q 184 44 218 5 Q 219 2 222 0 Q 238 -16 250 10 Q 265 50 264 95 Q 261 327 268 379 Q 275 406 266 416 Q 227 458 220 462 C 197 482 182 455 196 429 Z" fill="lightgray"></path>
    
      <path d="M 583 682 Q 607 727 613 732 Q 620 739 617 749 Q 614 759 600 770 Q 563 797 531 788 Q 522 784 526 772 Q 548 694 437 525 Q 328 395 296 360 Q 289 354 299 352 Q 356 361 468 492 Q 529 582 569 655 L 583 682 Z" fill="lightgray"></path>
    
      <path d="M 569 655 Q 654 538 766 416 Q 785 395 817 397 Q 926 403 961 409 Q 971 412 972 417 Q 972 423 958 429 Q 796 486 717 556 Q 654 611 583 682 C 562 703 551 679 569 655 Z" fill="lightgray"></path>
      ...
      <clipPath id="make-me-a-hanzi-clip-1">
        <path d="M 196 429 Q 217 398 219 310 Q 219 193 196 95 Q 184 44 218 5 Q 219 2 222 0 Q 238 -16 250 10 Q 265 50 264 95 Q 261 327 268 379 Q 275 406 266 416 Q 227 458 220 462 C 197 482 182 455 196 429 Z"></path>
      </clipPath>
      ...
      <clipPath id="make-me-a-hanzi-clip-3">
        <path d="M 569 655 Q 654 538 766 416 Q 785 395 817 397 Q 926 403 961 409 Q 971 412 972 417 Q 972 423 958 429 Q 796 486 717 556 Q 654 611 583 682 C 562 703 551 679 569 655 Z"></path>
      </clipPath>
