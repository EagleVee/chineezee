module.exports = `<svg version="1.1" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="scale(1, -1) translate(0, -900)">
    <style type="text/css">
      ...
      <path d="M 346 360 Q 506 403 693 547 Q 714 566 743 579 Q 759 589 756 600 Q 750 610 728 622 Q 676 644 647 641 Q 634 640 636 625 Q 627 544 362 389 Q 353 386 347 381 C 321 366 317 352 346 360 Z" fill="lightgray"></path>
      ...
      <clipPath id="make-me-a-hanzi-clip-0">
        <path d="M 346 360 Q 506 403 693 547 Q 714 566 743 579 Q 759 589 756 600 Q 750 610 728 622 Q 676 644 647 641 Q 634 640 636 625 Q 627 544 362 389 Q 353 386 347 381 C 321 366 317 352 346 360 Z"></path>
      </clipPath>
