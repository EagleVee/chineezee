module.exports = `<svg version="1.1" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="scale(1, -1) translate(0, -900)">
    <style type="text/css">
      ...
      <path d="M 362 610 Q 399 597 472 606 Q 595 627 725 647 Q 788 660 797 668 Q 807 677 803 686 Q 796 699 763 710 Q 729 717 625 686 Q 472 653 357 645 Q 350 645 348 643 C 318 638 333 618 362 610 Z" fill="lightgray"></path>
    
      <path d="M 279 350 Q 249 191 150 19 Q 146 12 143 6 Q 142 -4 152 -2 Q 188 5 258 131 Q 268 155 281 180 Q 339 321 350 504 Q 353 601 362 610 C 368 630 368 630 348 643 Q 300 676 278 667 Q 266 660 274 646 Q 293 619 294 548 Q 293 541 293 531 Q 293 455 284 386 L 279 350 Z" fill="lightgray"></path>
      ...
      <path d="M 284 386 Q 95 299 67 297 Q 54 294 54 284 Q 54 271 64 265 Q 88 252 121 240 Q 131 239 142 248 Q 164 273 279 350 C 304 367 311 399 284 386 Z" fill="lightgray"></path>
