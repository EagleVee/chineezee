  ...
  <g transform="scale(1, -1) translate(0, -900)">
    <style type="text/css">
        ...
        #make-me-a-hanzi-animation-8 {
          ...
          animation-delay: 5.262532552083334s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-9 {
          ...
          animation-delay: 5.947916666666667s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-12 {
          ...
          animation-delay: 7.93408203125s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-14 {
          ...
          animation-delay: 9.409016927083332s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-15 {
          ...
          animation-delay: 10.002441406249998s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-16 {
          animation: keyframes16 0.8050130208333334s both;
          animation-delay: 10.659342447916664s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-17 {
          animation: keyframes17 0.49658203125s both;
          animation-delay: 11.464355468749998s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-18 {
          animation: keyframes18 0.5087890625s both;
          animation-delay: 11.960937499999998s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-19 {
          animation: keyframes19 0.8660481770833334s both;
          animation-delay: 12.469726562499998s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-20 {
          animation: keyframes20 0.50146484375s both;
          animation-delay: 13.335774739583332s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-21 {
          animation: keyframes21 0.50390625s both;
          animation-delay: 13.837239583333332s;
          animation-timing-function: linear;
        }
        ...
        #make-me-a-hanzi-animation-22 {
          animation: keyframes22 0.98486328125s both;
          animation-delay: 14.341145833333332s;
          animation-timing-function: linear;
        }
